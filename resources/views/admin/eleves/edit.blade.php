        ...
        <div>
            <section class="settings-section">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('admin.students.update', $eleve) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="form-group">
                            <label class="form-label">Nom</label>
                            <input type="text" name="nom" class="form-input" value="{{ old('nom', $eleve->nom) }}"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="form-label">Lieu de naissance</label>
                            <input type="text" name="lieu_naissance" class="form-input"
                                value="{{ old('lieu_naissance', $eleve->lieu_naissance) }}">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Téléphone tuteur</label>
                            <input type="text" name="telephone_tuteur" class="form-input"
                                value="{{ old('telephone_tuteur', $eleve->telephone_tuteur) }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="form-label">Photo actuelle</label>
                            @if ($eleve->photo)
                                <img src="{{ asset('storage/' . $eleve->photo) }}" width="120"
