                ...
                <div class="form-col">
                    ...
                    <div class="field-group highlight-field">
                        ...
                        <div class="input-wrapper">
                            <input type="password" name="current_password" id="current_password" placeholder="Mot de passe actuel" autocomplete="new-password">
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-wrapper">
                            <input type="password" name="password_confirmation" id="password_confirm" placeholder="Répéter le mot de passe">
...
[data-theme='carbon'] .profile-modern-page, .carbon .profile-modern-page { 
    --p-bg: #0f172a; 
    --p-card: #1e293b; /* Couleur de carte plus claire que le fond noir */
    --p-text: #f8fafc; 
    --p-muted: #94a3b8; 
    --p-border: #334155; 
}
...
.save-btn-modern { width: 100%; background: var(--p-primary); color: white; border: none; padding: 16px; border-radius: 14px; font-weight: 700; font-size: 16px; cursor: pointer; transition: 0.3s; margin-top: 20px;}
...
<script>
    ...
    window.onload = () => {
        ...
        @if ($errors->has('current_password'))
            createToast("⚠️ Confirmer votre mot de passe d'abord", "#ef4444");
        @elseif ($errors->any())
